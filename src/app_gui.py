...
COULEUR_BG        = "#0f1117"
COULEUR_SURFACE   = "#1a1d2e"
COULEUR_CARD      = "#252840"
COULEUR_ACCENT    = "#6c63ff"
COULEUR_ACCENT2   = "#ff6584"
COULEUR_TEXTE     = "#e2e8f0"
COULEUR_TEXTE_SUB = "#94a3b8"
COULEUR_SUCCES    = "#22d3a0"
COULEUR_ERREUR    = "#ff4757"
COULEUR_BORDER    = "#2d3148"
...
class EsportApp(tk.Tk):
    ...
    def _creer_bouton_nav(self, parent, texte, cle):
        ...
        btn.bind("<Enter>", lambda e, b=btn: b.configure(bg=COULEUR_CARD))
    ...
    def _afficher_vue(self, cle):
        ...
        for k, btn in self.boutons_nav.items():
            btn.configure(bg=COULEUR_ACCENT if k == cle else COULEUR_SURFACE)
...
def champ_label(parent, label, **kwargs):
    ...
    entry = tk.Entry(
        ...
        highlightbackground=COULEUR_BORDER,
        **kwargs
    )
...
def tableau(parent, colonnes, hauteur=15):
    ...
    style.configure("Esport.Treeview",
        ...
        fieldbackground=COULEUR_SURFACE,
        rowheight=30,
        font=FONT_BODY,
        borderwidth=0
    )
    style.configure("Esport.Treeview.Heading",
        background=COULEUR_CARD,
    ...
    cadre = tk.Frame(parent, bg=COULEUR_SURFACE)
...
class VueRechercher(tk.Frame):
    ...
    def _construire(self):
        ...
        self.e_critere = tk.Entry(
            ligne, font=FONT_BODY, bg=COULEUR_SURFACE, fg=COULEUR_TEXTE,
...
class VueDetail(tk.Frame):
    ...
    def _construire(self):
        ...
        self.e_id = tk.Entry(
            ...
            insertbackground=COULEUR_TEXTE, relief="flat",
            highlightthickness=1, highlightcolor=COULEUR_ACCENT,
            highlightbackground=COULEUR_BORDER, width=12
        )
